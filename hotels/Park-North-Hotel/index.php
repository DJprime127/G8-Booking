	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<div class="content">
					<ol class="breadcrumb">
						<h1 class="text-center" style="font-size: 32px">Park North Hotel</h1>
					</ol>
				</div>
			</div>
		</div>
		...
		<div class="row">
		  ...
		  <p>&nbsp;</p>
			...
			<div class="col-md-9">
				  <div style="">
					<div style="">
						<img src="../../assets/images/hotels/Park North Hotel.jpg" width="446" height="321" style="padding-bottom:10px">
						...
						<div class="container-fluid">
							...
							<div class="container-fluid">
									<h1 style="font-size:20px">Weekend differential</h1>
										<div class="col-md-12" style="right:15px"><li>Weekend differential: 15% nightly rate surcharge</p></li></div></div>
