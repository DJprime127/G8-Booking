	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<div class="content">
					<ol class="breadcrumb">
						<h1 class="text-center" style="font-size: 32px">The Comfy Motel Place<Place></Place></h1>
					</ol>
				</div>
			</div>
		</div>
		...
		<div class="row">
		  ...
		  <p>&nbsp;</p>
			...
			<div class="col-md-9">
				  <div style="">
					<div style="">
						<img src="../../assets/images/hotels/The Comfy Motel Place.jpg" width="446" height="321" style="padding-bottom:10px">
						<img style="position: absolute; width: 272px; height: 154px; left: 466px; top: 0px;" src="../../assets/images/hotels/MAS-pool.jpg">
						<img style="position: absolute; width: 269px; height: 148px; left: 468px; top: 162px;" src="../../assets/images/hotels/MAS-room.jpg">
					</div>
			  </div>
			...
			<div class="col-md-4" style="right: 50px">
						...
						<div class="container-fluid">
							...
							<div class="container-fluid">
									<h1 style="font-size:20px">Weekend differential</h1>
										<div class="col-md-12" style="right:15px"><li>Weekend differential: 25% nightly rate surcharge</p></li></div></div>
					
					<div class="container-fluid">
										<h1 style="font-size:20px; padding-right: 15px">Pets</h1>
						<div class="col-md-12" style="right:15px">
							<li>Pets NOT allowed</li>
							<li>Any pets found will result in eviction</li></div>
				</div>
					<div class="container-fluid">
