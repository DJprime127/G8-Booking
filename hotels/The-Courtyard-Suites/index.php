	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<div class="content">
					<ol class="breadcrumb">
						<h1 class="text-center" style="font-size: 32px">The Courtyard Suites</h1>
					</ol>
				</div>
			</div>
		</div>
		...
		<div class="row">
		  ...
		  <p>&nbsp;</p>
			...
			<div class="col-md-9">
				  <div style="">
					<div style="">
						<img src="../../assets/images/hotels/The Courtyard Suites.jpg" width="446" height="321" style="padding-bottom:10px">
